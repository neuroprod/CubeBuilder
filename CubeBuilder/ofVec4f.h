...
public:
	...
	ofVec4f( float _x=0.f, float _y=0.f, float _z=0.f, float _w=1.f );
    ...
    ofVec4f  getCross( const ofVec4f& pnt ) const;
...
inline ofVec4f  ofVec4f::getCross( const ofVec4f& pnt ) const
{


    return ofVec4f( y* pnt.z-z*pnt.y,
				   x* pnt.z-z*pnt.x,
				   y* pnt.x-x*pnt.y,
				   0 );
